#!/bin/bash
# Outputs a table containing the in domain accuracy for all tracked pairs of agents for a dense community containing 5 pools. See lines 23 - 52 for more details on the tracked agents.
